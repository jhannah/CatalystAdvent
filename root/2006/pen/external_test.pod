...
with this:
  ...
  $ENV{CATALYST_SERVER} = "http://localhost/myapp:$port";
...
this:
 ...
 <IfModule mod_fastcgi.c>
     ...
     FastCgiServer /path/to/MyApp/script/fscms_fastcgi.pl -idle-timeout 300 -processes 1
      ScriptAlias / /path/to/MyApp/t/tmp/lib/FSCMS/script/fscms_fastcgi.pl/
