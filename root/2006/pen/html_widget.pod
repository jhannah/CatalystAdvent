...
Let's add a simple feedback form to the Cheer project. First thing, add the 
L<Catalyst::Plugin::HTML::Widget> in the plugin list, in Cheer.pm. It brings 
some advantages, you can read all about it in the POD. Then open Root.pm and 
type your form:
...
from HTML::Widget::Container, ready for our changes:
