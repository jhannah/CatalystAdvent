...
Now let's create the temple. Create a new file in your editor of choice, and
...
will cause it to be rendered. Let's test it!
...
hopefully this will be fixed in newer versions) where all system calls return
