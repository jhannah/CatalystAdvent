...
different from a standard catalyst application - we're using a Chained
dispatch type.  This alters the behaviour of the arguments and
dispatch chain compared to a standard Catalyst application.
