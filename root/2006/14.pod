...
Windows). In this example, job is run as a HTTP request, so you can
reuse you Catalyst application code.
...
how often your job will be run (it's in crontab syntax,
...
and the address that you want to see the mail report coming from on the
