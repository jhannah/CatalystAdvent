...
Lastly we need some CSS to make the dropdown look nice. Put this in
...
Now lets type a letter in our autocomplete input field and see what happens:
 ...
 [debug] Looking through these users: fred wilma barney ghenry betty dino bart homer pebles lisa maggie
...
You don't need to use Protitype to use this, you could use Dojo, Jquery or YUI Javascript toolkits to name just three. The choice is yours.
