...
outgoing characters output to Unicode (UTF-8) octets.  This applies to
data coming from a C< Catalyst::Model >), or from C< $c->req->params >
or example.  Only the body is encoded -- you should avoid using
