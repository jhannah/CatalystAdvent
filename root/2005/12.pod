=head1 Catalyst Advent - Day 12 - L<Catalyst::Plugin::Subrequest> - Component based sub-requests.
...
It's quite simple in use. You just call C<$c->subreq('</public/url>');> (or 
...
to the request like a normal form POST. for example:
