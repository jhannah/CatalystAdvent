...
Role checking is done by using the C<< $c->check_roles >> method, this will
...
L<http://http://search.cpan.org/~nuffin/Catalyst-Plugin-Authentication-0.04/lib/Catalyst/Plugin/Authentication.pm|Catalyst::Plugin::Authentication> has a longer explanation.
