...
controller package is always included.
...
to set up variables/data for this particular part of your app.
...
is always called after any actions when
...
Last but not least, the auto action is magic in that B<every> auto action in
